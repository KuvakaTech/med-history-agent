  ...
  return (
    <div className="flex flex-col items-center space-y-8 py-8 fade-up">
      ...
      <div className="text-center">
        <h2 className="text-xl font-bold text-gray-900">Analysing your responses…</h2>
        <p className="text-gray-400 text-sm mt-1">This takes 15–30 seconds. Please wait.</p>
      </div>
        ...
        {steps.map((step) => (
          ...
          >
            ...
            <span className={clsx(
              ...
              step.state === "running" && "text-brand font-semibold",
